...
@JsonPropertyOrder({
    ...
    "modifiedAt",
    "dateOfEntry",
    "dateOfEntryUtcOffset",
    "dateOfEntryUtcOffsetSeconds",
    "dateOfEntryLocal",
    "points",
    "bloodGlucoseMeasurement",
    "penBolusInjectionUnits",
    "penBasalInjectionUnits",
    "mealCarbohydrates",
    "mealDescriptionText",
    ...
    "locationText",
    "note",
    "nutritionalConstituents",
    "bolusFoodInsulinUnits",
    "locationType",
    "locationLatitude",
    "locationLongitude",
    "bolusCorrectionInsulinUnits",
    "verifications",
    "mealImages"
})
