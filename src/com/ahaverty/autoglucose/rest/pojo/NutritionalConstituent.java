...
public class NutritionalConstituent implements Serializable {

	private static final long serialVersionUID = 242812020177791208L;
	@JsonProperty("name")
    private String name;
    @JsonIgnore
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NutritionalConstituent) == false) {
            return false;
        }
        NutritionalConstituent rhs = ((NutritionalConstituent) other);
